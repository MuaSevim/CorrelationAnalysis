...
/**
 * Each of them is a item in the list
 * I should loop over each of them and store them in some kind of data structure
 * And then I should order them from highest to lowest etc.
 */
